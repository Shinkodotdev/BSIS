...
<section class="max-w-6xl mx-auto py-2 px-6 grid md:grid-cols-3 gap-8">
    <!-- Address Card -->
    <a href="https://maps.app.goo.gl/Ev1fAZ4sop4kFgNdA" target="_blank"
        class="block bg-white shadow-md p-8 rounded-xl text-center hover:shadow-lg transition no-underline">
    ...
    <!-- Email Card -->
    <a href="mailto:poblacionsur648@gmail.com"
        class="block bg-white shadow-md p-8 rounded-xl text-center hover:shadow-lg transition no-underline">
...
<section class="max-w-6xl mx-auto py-2 px-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white shadow-lg rounded-xl p-8">
        ...
        <!-- Google Map -->
        <div>
            <iframe title="Barangay Poblacion Sur Location"
