...
$announcementsStmt = $pdo->prepare("
    ...
    FROM announcements
    WHERE (audience = 'Official' OR audience = 'Public' OR audience = 'Resident')
        AND is_deleted = 0
        AND is_archived = 0
...
<body class="bg-gray-100">
    ...
    <main class="pt-24 px-4 sm:px-6 lg:px-10 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="official_announcement_events.php" target="_blank"
                ...
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-extrabold text-yellow-800 mt-2">Manage</p>
                </div>
